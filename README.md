...
- **回退**：`2026-08-29` 强制 `klein-etch`（即使 JSON 仍写 klein-halftone）；`2026-09-03` 强制 `vintage-seal`（即使 JSON 仍写 impasto-card）；`>= 2026-08-30` 且主题空/未知 → `printed-logic`；`2026-08-22`–`2026-08-28` 未知主题 → `klein-halftone`；`<= 2026-08-21` → 旧报纸。首页永远 `klein-poster`。
